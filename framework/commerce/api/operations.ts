...
export type Operations<P extends APIProvider> = {
  ...
  getAllBlogPaths: {
    <T extends GetAllBlogPathsOperation>(opts: { variables?: T['variables']; config?: P['config'] }): Promise<
      T['data']
    >;
  ...
  getBlog: {
    <T extends GetBlogOperation>(opts: { variables: T['variables']; config?: P['config']; preview?: boolean }): Promise<
      T['data']
    >;

    <T extends GetBlogOperation>(
      opts: {
        variables: T['variables'];
        config?: P['config'];
        preview?: boolean;
  ...
  getAllArticlePaths: {
    <T extends GetAllArticlePathsOperation>(opts: { variables?: T['variables']; config?: P['config'] }): Promise<
      T['data']
    >;

    <T extends GetAllArticlePathsOperation>(
      opts: {
        variables?: T['variables'];
        config?: P['config'];
      } & OperationOptions
  ...
  getArticle: {
    <T extends GetArticleOperation>(opts: {
      variables: T['variables'];
      config?: P['config'];
      preview?: boolean;
    }): Promise<T['data']>;

    <T extends GetArticleOperation>(
      opts: {
        variables: T['variables'];
        config?: P['config'];
        preview?: boolean;
