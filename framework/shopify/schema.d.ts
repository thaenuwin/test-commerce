...
export type GetAllArticlePathsQueryVariables = Exact<{
  first?: Maybe<Scalars['Int']>;
  cursor?: Maybe<Scalars['String']>;
}>;

export type GetAllArticlePathsQuery = { __typename?: 'QueryRoot' } & {
  articles: { __typename?: 'ArticleConnection' } & {
    pageInfo: { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasNextPage' | 'hasPreviousPage'>;
    edges: Array<
      { __typename?: 'ArticleEdge' } & Pick<ArticleEdge, 'cursor'> & {
          node: { __typename?: 'Article' } & Pick<Article, 'handle'> & {
              blog: { __typename?: 'Blog' } & Pick<Blog, 'handle'>;
            };
        }
    >;
  };
...
export type GetArticlesQuery = { __typename?: 'QueryRoot' } & {
  articles: { __typename?: 'ArticleConnection' } & {
    edges: Array<
      { __typename?: 'ArticleEdge' } & {
        node: { __typename?: 'Article' } & Pick<
          Article,
          'id' | 'handle' | 'title' | 'tags' | 'excerpt' | 'publishedAt'
        >;
      }
    >;
  };
...
export type GetAllBlogPathsQueryVariables = Exact<{
  first?: Maybe<Scalars['Int']>;
  cursor?: Maybe<Scalars['String']>;
}>;

export type GetAllBlogPathsQuery = { __typename?: 'QueryRoot' } & {
  blogs: { __typename?: 'BlogConnection' } & {
    pageInfo: { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasNextPage' | 'hasPreviousPage'>;
    edges: Array<
      { __typename?: 'BlogEdge' } & Pick<BlogEdge, 'cursor'> & { node: { __typename?: 'Blog' } & Pick<Blog, 'handle'> }
    >;
  };
};
...
export type GetBlogsQuery = { __typename?: 'QueryRoot' } & {
  blogs: { __typename?: 'BlogConnection' } & {
    edges: Array<
      { __typename?: 'BlogEdge' } & { node: { __typename?: 'Blog' } & Pick<Blog, 'id' | 'title' | 'handle'> }
    >;
  };
};
...
export type GetAllPagesQuery = { __typename?: 'QueryRoot' } & {
  pages: { __typename?: 'PageConnection' } & {
    edges: Array<
      { __typename?: 'PageEdge' } & { node: { __typename?: 'Page' } & Pick<Page, 'id' | 'title' | 'handle'> }
    >;
  };
};
...
export type GetArticleByHandleQuery = { __typename?: 'QueryRoot' } & {
  blogByHandle?: Maybe<
    { __typename?: 'Blog' } & {
...
export type GetBlogQuery = { __typename?: 'QueryRoot' } & {
  blogByHandle?: Maybe<
    { __typename?: 'Blog' } & Pick<Blog, 'id' | 'handle' | 'title' | 'url'> & {
        seo?: Maybe<{ __typename?: 'SEO' } & Pick<Seo, 'description' | 'title'>>;
      }
  >;
};
...
export type GetProductBySlugQuery = { __typename?: 'QueryRoot' } & {
  productByHandle?: Maybe<
    { __typename?: 'Product' } & Pick<
      Product,
      'id' | 'handle' | 'availableForSale' | 'title' | 'productType' | 'vendor' | 'description' | 'descriptionHtml'
    > & {
...
export type GetSiteInfoQuery = { __typename?: 'QueryRoot' } & { shop: { __typename?: 'Shop' } & Pick<Shop, 'name'> };
